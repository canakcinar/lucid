...
var secretPatterns = []struct {
	...
	// The  sweep on config-api.tld carried `"client.id": "0oaxo6uywvW6qgvdt697"`
	...
	// AWS API Gateway URLs — the  sweep found production API Gateway hostnames
...
// existing callers keep working. scanSecretsWithValues (below) is the  replacement
